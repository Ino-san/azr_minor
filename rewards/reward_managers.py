...
import azr_minor.rewards.custom_evaluate as custom_evaluate
from azr_minor.rewards.code_reward import (
...
from azr_minor.rewards.custom_evaluate import get_format_reward, extract_answer, extract_thought
from azr_minor.data_construction.process_data import boxed_instruction, instruction_following
from azr_minor.data_construction.constructor import get_code_problem_predictor_prompt
from azr_minor.utils.dataset.rl_dataset import RLHFDataset
from azr_minor.utils.logging_utils.stdout import PrettyPrinter
from azr_minor.utils.code_utils.checks import check_composite_function, check_no_definitions
    ...
    def _get_problem_generator_rewards_and_valid_programs(
        ...
        for d in data_dicts:
            ...
            if self.generation_reward_config.generation_accuracy_convertion == 'one_minus':
                ...
                rewards[uid]['accuracy'] = 0.5 + accuracies[uid]  * (1 - accuracies[uid]) * 2 # peak at 0.5, scaled to [0.5, 1]
